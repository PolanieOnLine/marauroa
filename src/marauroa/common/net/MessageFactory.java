...
public class MessageFactory {
	...
	private void register() {
		...
		register(Message.MessageType.C2S_LEAVECHARACTER, MessageC2SLeaveCharacter.class);
		register(Message.MessageType.S2C_LEAVECHARACTER_ACK, MessageS2CLeaveCharacterACK.class);
		register(Message.MessageType.S2C_LEAVECHARACTER_NACK, MessageS2CLeaveCharacterNACK.class);
